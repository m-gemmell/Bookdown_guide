...
The function `tippy:tippy_this()` will add a tooltip to a specified item.
...
I would suggest adding the following to your __style.css__ file to increase the text and box size of the tooltip.
...
````{verbatim}
A compass `r icons::icon_style(icons::fontawesome("rocket", style="solid"), fill = "#648fff")` is useful to find north.
````
